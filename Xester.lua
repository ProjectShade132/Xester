...
mfMask.MeshId = 'http://www.roblox.com/asset/?id=0'
...
mjester.MeshId,mjester.TextureId = 'rbxassetid://0','rbxassetid://0'
...
maskweld.C0 = CFrame.new(0,-0,0) * CFrame.Angles(math.rad(0),0,0)
mMask = Instance.new("SpecialMesh", mask)
mMask.MeshType = "FileMesh"
mMask.Scale = Vector3.new(0, 0, 0)
...
doomtheme.SoundId = "rbxassetid://1836779874"
doomtheme:Play()
doomtheme.Volume = 2
...
mjester.TextureId = "rbxassetid://0"
...
mMask.MeshId = "rbxassetid://0"
mMask.Scale = Vector3.new(1.1, 1, 1)
mMask.TextureId = "rbxassetid://0"
eyo1:Remove()
eyo2:Remove()
coroutine.wrap(function()
while levitate do
